...
final class LoggerProviderLog4J implements LoggerProvider {
	...
	private static class Log4JLogger implements Logger {
		...
		public boolean isErrorEnabled() {
			return log4JLogger.isEnabled(org.apache.logging.log4j.Level.ERROR);
		}
	
		public boolean isWarnEnabled() {
			return log4JLogger.isEnabled(org.apache.logging.log4j.Level.WARN);
		}
	
		public boolean isInfoEnabled() {
			return log4JLogger.isEnabled(org.apache.logging.log4j.Level.INFO);
		}
	
		public boolean isDebugEnabled() {
			return log4JLogger.isEnabled(org.apache.logging.log4j.Level.DEBUG);
		}
	}
}
