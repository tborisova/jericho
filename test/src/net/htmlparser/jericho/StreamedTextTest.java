...
public class StreamedTextTest {
	...
	@Test public void testFixedBuffer() {
		...
		assertEquals(StreamedText.END_OF_STREAM,streamedText.charAt(36));
//		try {
...
//		} catch (IndexOutOfBoundsException ex) {}
	...
	@Test public void testEndOfFileFoundWhileSkipping() {
		Reader reader=new StringReader(text);
		char[] buffer=new char[10];
		StreamedText streamedText=new StreamedText(reader,buffer);
		...
		assertEquals(StreamedText.END_OF_STREAM,streamedText.charAt(40));
//		try {
...
//		} catch (IndexOutOfBoundsException ex) {}
	...
	@Test public void testCharBuffer() {
		...
		streamedText.setMinRequiredBufferBegin(20);
		assertEquals('A',streamedText.charAt(0));
		assertEquals(StreamedText.END_OF_STREAM,streamedText.charAt(26));
//		try {
